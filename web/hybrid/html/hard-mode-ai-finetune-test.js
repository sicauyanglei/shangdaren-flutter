...
// 精细调优参数组合
const paramSets = [
  { name: '原始', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 150, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'tingWidth-180', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 180, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'tingWidth-200', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 200, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'tingWidth-220', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 220, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'makesTing-2500', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2500, tingWidth: 180, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'makesTing-3000', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 3000, tingWidth: 180, nearTing: 300, specialCard: 50, specialSentence: 30 },
  { name: 'nearTing-400', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 180, nearTing: 400, specialCard: 50, specialSentence: 30 },
  { name: '综合A', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2500, tingWidth: 200, nearTing: 350, specialCard: 50, specialSentence: 30 },
  { name: '综合B', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1200, makesTing: 2500, tingWidth: 180, nearTing: 350, specialCard: 50, specialSentence: 30 },
];

console.log('========================================');
console.log('  困难模式AI精细调优测试');
console.log('========================================\n');
...
for (const params of paramSets) {
  ...
  console.log(`${params.name.padEnd(18)} 胡牌率: ${result.huRate}%  听牌率: ${result.tingRate}%`);
}
