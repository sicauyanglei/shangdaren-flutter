...
function simulateGame(selectFunc, numGames = 500) {
    ...
    while (turn < 300 && deck.length > 0) {
      ...
      for (let p = 0; p < 4; p++) {
        ...
        if (p === 0) {
          ...
          // 出牌
          const discardIndex = selectFunc(player);
          ...
          // 摸牌后检查胡牌
          if (checkHu(player.hand, player.melds).canHu) {
            totalHu++;
...
function testParams(params, numGames = 500) {
  ...
  const result = simulateGame(selectAIDiscard, numGames);
  return { huRate: (result.hu / numGames * 100).toFixed(1), tingRate: (result.ting / numGames * 100).toFixed(1) };
}

// 参数组合测试
const paramSets = [
  { name: '基础', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 100, nearTing: 300, specialCard: 50 },
  { name: '提高3张', sameFour: 200, sameThree: 150, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 100, nearTing: 300, specialCard: 50 },
  { name: '提高4张', sameFour: 250, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 100, nearTing: 300, specialCard: 50 },
  { name: '激进听牌', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 800, makesTing: 3000, tingWidth: 200, nearTing: 400, specialCard: 40 },
  { name: '向听优先', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1500, makesTing: 1500, tingWidth: 80, nearTing: 200, specialCard: 50 },
  { name: '特殊牌', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 100, nearTing: 300, specialCard: 80 },
  { name: '综合A', sameFour: 250, sameThree: 150, sameTwo: 60, single: -30, tingImprovement: 1200, makesTing: 2500, tingWidth: 120, nearTing: 350, specialCard: 60 },
  { name: '综合B', sameFour: 300, sameThree: 180, sameTwo: 80, single: -20, tingImprovement: 1500, makesTing: 2000, tingWidth: 100, nearTing: 400, specialCard: 70 },
];

console.log('========================================');
console.log('  困难模式AI参数优化测试 v2');
console.log('========================================\n');
