...
function testParams(params, numGames = 500) {
  ...
  function simulateGame() {
    let totalHu = 0, totalTing = 0, gameEnded = false;
...
// 测试最佳参数组合
const bestParams = { name: '最佳参数', sameFour: 200, sameThree: 120, sameTwo: 50, single: -40, tingImprovement: 1000, makesTing: 2000, tingWidth: 150, nearTing: 300, specialCard: 50, specialSentence: 30 };

console.log('========================================');
console.log('  困难模式AI最终验证测试');
console.log('========================================\n');
...
// 运行5次测试验证稳定性
for (let i = 0; i < 5; i++) {
  const result = testParams(bestParams, 500);
  console.log(`第${i+1}次: 胡牌率: ${result.huRate}%  听牌率: ${result.tingRate}%`);
}
